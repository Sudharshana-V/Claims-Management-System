...
create table claim(claim_id int,amount_claimed double,amount_settled double,benefit_id int,claim_status varchar(20),claim_description varchar(30),member_id int,policy_id int,provider_id int);
/* inserting in claim*/
insert into claim (claim_id,amount_claimed,amount_settled,benefit_id,claim_status,claim_description,member_id,policy_id,provider_id) values(1,50000.0,50000.0,202,'claimed','City hospital accident claim',1,3,3);
insert into claim (claim_id,amount_claimed,amount_settled,benefit_id,claim_status,claim_description,member_id,policy_id,provider_id) values(2,42000.0,42000.0,205,'claimed','LIC claim',2,1,4);
insert into claim (claim_id,amount_claimed,amount_settled,benefit_id,claim_status,claim_description,member_id,policy_id,provider_id) values(3,90000.0,50000.0,201,'not claimed','HDFC claim',2,2,1);
