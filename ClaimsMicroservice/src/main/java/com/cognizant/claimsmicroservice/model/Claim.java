...
public class Claim {
	...
	public String toString() {
		return "Claim [claimId=" + claimId + ", claimStatus=" + claimStatus + ", description=" + description
				+ ", policyId=" + policyId + ", memberId=" + memberId + ", benefitId=" + benefitId + ", providerId="
				+ providerId + ", amountClaimed=" + amountClaimed + ", amountSettled=" + amountSettled + "]";
	}
