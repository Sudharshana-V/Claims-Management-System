...
//		memberPolicy= new MemberPolicy(1, 1, 101, 201, strDate, 21, 100000.00);
	...
	@Test
	 void testsetBenefitId() {
		memberPolicy = new MemberPolicy();
		memberPolicy.setBenefitId(1);
		assertEquals(1,memberPolicy.getBenefitId());	
	...
	@Test
	 void testsetTenure() {
		memberPolicy = new MemberPolicy();
		memberPolicy.setTenure(1);
		assertEquals(1,memberPolicy.getTenure());	
				
	}
	
	@Test
	 void testsetCapAmountBenefits() {
		memberPolicy = new MemberPolicy();
		memberPolicy.setCapAmountBenefits(100.0);
		assertEquals(100.0,memberPolicy.getCapAmountBenefits());	
