...
public class ClaimServiceImplTest {
	...
	void setUp() throws ParseException {
		...
		memberClaim.setDescription("memberClaim has been submitted! Please check after few days for confirmation");
		memberClaim.setPolicyId(1);
		memberClaim.setBenefitId(202);
		memberClaim.setMemberId(1);
		memberClaim.setProviderId(1);
		memberClaim.setAmountSettled(60000.0);
		memberClaim.setAmountClaimed(60000.0);
